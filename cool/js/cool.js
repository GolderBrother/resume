window.onload = function(){
	...
	/*开机动画结束*/
		...
		var aTimeArr = ['','','','','','','',''] //记录时间
		var aTimeArr1 = ['工作职位：Web 前端实习生','工作职位：Web 前端开发工程师','工作职位：敬请期待','工作职位：敬请期待','工作职位：敬请期待','工作职位：敬请期待','工作职位：敬请期待','工作职位：敬请期待']//工作时间
		var aTimeArr2 = [
				'根据效果图，负责把网站静态化排版和配合后端人员开发项目，项目包括PC 站，响应式网站。以及网站特效，浏览器兼容性和屏幕的适配性',
				'根据效果图，开发公司项目，包括 PC 官网，移动端页面，公司活动项目,  桌面程序和混合 APP，保证网站特效，交互特效和响应式效果，浏览器兼容性和屏幕的适配性，性能优化等。',
				'敬请期待',
				'敬请期待',
				'敬请期待',
				'敬请期待',
